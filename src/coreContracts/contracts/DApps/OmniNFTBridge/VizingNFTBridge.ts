...
export interface VizingNFTBridgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_GASLIMIT"
      | "LandingPad"
  ...
  getEvent(
    nameOrSignatureOrTopic: "NewWrappedToken" | "OwnershipTransferred"
  ): EventFragment;
...
export interface VizingNFTBridge extends BaseContract {
  connect(runner?: ContractRunner | null): VizingNFTBridge;
  waitForDeployment(): Promise<this>;

  interface: VizingNFTBridgeInterface;
