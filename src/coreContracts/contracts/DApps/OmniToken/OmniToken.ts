...
export interface OmniTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LandingPad"
      | "LaunchPad"
  ...
  encodeFunctionData(
    functionFragment: "getLaunchHooks",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface OmniToken extends BaseContract {
  connect(runner?: ContractRunner | null): OmniToken;
  waitForDeployment(): Promise<this>;

  interface: OmniTokenInterface;
  ...
  getLaunchHooks: TypedContractMethod<[hook: BytesLike], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "getLaunchHooks"
