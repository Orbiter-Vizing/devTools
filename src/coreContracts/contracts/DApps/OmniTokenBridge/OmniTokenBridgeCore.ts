...
export interface OmniTokenBridgeCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BRIDGE_SEND_MODE"
      | "DEFAULT_GASLIMIT"
...
export interface OmniTokenBridgeCore extends BaseContract {
  connect(runner?: ContractRunner | null): OmniTokenBridgeCore;
  waitForDeployment(): Promise<this>;

  interface: OmniTokenBridgeCoreInterface;
