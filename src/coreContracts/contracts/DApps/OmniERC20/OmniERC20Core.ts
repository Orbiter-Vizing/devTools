...
export interface OmniERC20CoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LandingPad"
      | "LaunchPad"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Approval" | "Transfer" | "TransferToChain"
  ): EventFragment;
...
export interface OmniERC20Core extends BaseContract {
  connect(runner?: ContractRunner | null): OmniERC20Core;
  waitForDeployment(): Promise<this>;

  interface: OmniERC20CoreInterface;
