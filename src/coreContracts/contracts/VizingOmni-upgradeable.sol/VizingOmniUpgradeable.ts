...
export interface VizingOmniUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LandingPad"
      | "LaunchPad"
...
export interface VizingOmniUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): VizingOmniUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: VizingOmniUpgradeableInterface;
