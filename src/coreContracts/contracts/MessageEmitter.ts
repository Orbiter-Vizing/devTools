...
export interface MessageEmitterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LaunchPad"
...
export interface MessageEmitter extends BaseContract {
  connect(runner?: ContractRunner | null): MessageEmitter;
