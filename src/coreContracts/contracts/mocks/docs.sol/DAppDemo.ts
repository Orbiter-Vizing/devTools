...
export interface DAppDemoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LandingPad"
      | "LaunchPad"
...
export interface DAppDemo extends BaseContract {
  connect(runner?: ContractRunner | null): DAppDemo;
  waitForDeployment(): Promise<this>;

  interface: DAppDemoInterface;
