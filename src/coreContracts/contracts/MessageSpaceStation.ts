...
export interface MessageSpaceStationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "Chainid"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MessageSpaceStation extends BaseContract {
  connect(runner?: ContractRunner | null): MessageSpaceStation;
  waitForDeployment(): Promise<this>;

  interface: MessageSpaceStationInterface;
