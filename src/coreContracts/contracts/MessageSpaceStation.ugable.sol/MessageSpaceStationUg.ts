...
export interface MessageSpaceStationUgInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "Chainid"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MessageSpaceStationUg extends BaseContract {
  connect(runner?: ContractRunner | null): MessageSpaceStationUg;
  waitForDeployment(): Promise<this>;

  interface: MessageSpaceStationUgInterface;
