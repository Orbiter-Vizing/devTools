...
export interface IMessageEmitterInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IMessageEmitter extends BaseContract {
  connect(runner?: ContractRunner | null): IMessageEmitter;
  waitForDeployment(): Promise<this>;

  interface: IMessageEmitterInterface;
