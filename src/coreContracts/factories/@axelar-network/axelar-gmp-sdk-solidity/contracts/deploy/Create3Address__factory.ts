...
import type {
  Create3Address,
  Create3AddressInterface,
} from "../../../../../@axelar-network/axelar-gmp-sdk-solidity/contracts/deploy/Create3Address";
...
type Create3AddressConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: Create3AddressConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Create3Address__factory extends ContractFactory {
  constructor(...args: Create3AddressConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): Create3Address__factory {
    return super.connect(runner) as Create3Address__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): Create3AddressInterface {
    return new Interface(_abi) as Create3AddressInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): Create3Address {
    return new Contract(address, _abi, runner) as unknown as Create3Address;
  }
}
