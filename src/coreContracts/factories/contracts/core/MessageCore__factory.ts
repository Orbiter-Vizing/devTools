...
import type {
  MessageCore,
  MessageCoreInterface,
} from "../../../contracts/core/MessageCore";
...
export class MessageCore__factory {
  static readonly abi = _abi;
  static createInterface(): MessageCoreInterface {
    return new Interface(_abi) as MessageCoreInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): MessageCore {
    return new Contract(address, _abi, runner) as unknown as MessageCore;
  }
}
